export default function HomePanel() {
    return (
        <main>
            ...
            <ul>
                <li>Stat calculator for chiefs/alliances. Saves chief and alliance information in your browser so you can continue to update it to match in-game improvements.</li>
